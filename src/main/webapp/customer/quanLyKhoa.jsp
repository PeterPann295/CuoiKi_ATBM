...
<div class="container">
    ...
    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
        ...
        <li class="nav-item ml-2" style="margin-left: 5px" role="presentation">
            <a class="a " href="../customer?action=getOrderStatus&status=0"> <button type="button" class="btn btn-primary ">
                Tạo khóa mới (Auto)</button></a>
        </li>

        <li class="nav-item ml-2" style="margin-left: 5px" role="presentation">
            <a class="a " href="../customer?action=getOrderStatus&status=0"> <button type="button" class="btn btn-warning">
                    ...
                    <table class="styled-table">
                        ...
                        <c:forEach items="${keyPairModelDao.selectAllByCustomerId(customer_login.id)}" var="p">
                            <tr>
                                ...
                                <td class="text-center align-middle"><b>${p.status}</b></td>
                                <td class="text-center align-middle"><fmt:formatDate value="${p.createdAt}" pattern="dd/MM/yyyy" /></td>
                                <td class="text-center align-middle"><fmt:formatDate value="${p.revokedAt}" pattern="dd/MM/yyyy" /></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
